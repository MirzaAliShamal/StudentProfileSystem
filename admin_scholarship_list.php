    ...
    if(mysqli_num_rows($result) > 0){
        ...
        while($row = mysqli_fetch_array($result)){
          echo "<tbody><tr>";
            echo "<td>" . $row['id'] . "</td>";
            echo "<td>" . $row['name'] . "</td>";
            echo "<td><a href='admin_scholarship_edit.php?id=".$row['id']."'><i class='icofont-edit'></i></a> <a class='confirmation' href='admin_scholarship_delete.php?id=".$row['id']."'><i class='icofont-trash'></i></a></td>";
          echo "</tr></tbody>";
        }
        echo "</table>";
