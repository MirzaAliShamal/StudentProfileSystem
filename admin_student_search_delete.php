...
<head>
    ...
    <title>Dashboard: Student Search</title>
	<?php 
...
<body style="background-image: url('assets/img/logo.png'); background-attachment: fixed;">
	...
	<div class="row">
	<div class="col-3"></div>
	<div class="col-md-12 col-lg-6 bg-dark text-white p-5">			
	<p class="card-text">
	<h3 class="text-center mb-4">Delete Student Record</h3>
	<form method='get' action='admin_student_profile.php'>
