...
<head>
    ...
    <title>Dashboard: Issued Book Log</title>
	<?php 
...
<div class="row container-fluid bg-white p-4 ml-1 rounded">
			<div class="col-12">			
    ...
    if(mysqli_num_rows($result) > 0){
        ...
        while($row = mysqli_fetch_array($result)){
            echo "<tr style='border: 1px solid black'>";
				...
				echo "<td style='border: 1px solid black'><a class='confirmation'href='admin_book_recieved.php?id=".$row['id']."'>Click if Recieved</a></td>";
            echo "</tr>";
        }
        echo "</table>";
