...
if($result = mysqli_query($con, $sql)){
    if(mysqli_num_rows($result) > 0){
        echo "<table id='book_category' class='col-12 table table-bordered text-center table-hover'>";
          echo "<thead><tr>";
            echo "<th>Id</th>";
            echo "<th>Category</th>";
            echo "<th>Action</th>";
        ...
        while($row = mysqli_fetch_array($result)){
          echo "<tbody><tr>";
            ...
            echo "<td><a href='admin_book_category_edit.php?id=".$row['id']."'><i class='icofont-edit'></i></a> <a class='confirmation' href='admin_book_category_delete.php?id=".$row['id']."'><i class='icofont-trash'></i></a></td>";
          echo "</tr></tbody>";
        }
        echo "</table>";
